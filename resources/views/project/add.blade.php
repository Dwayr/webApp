                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="komicho-input-group">
                                ...
                                <input ng-model="projectAdd.title"/>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="komicho-input-group">
                                <label>الشركة</label>
                                <select ng-model="projectAdd.co_id" ng-init="projectAdd.co_id=''">
                    ...
                    <div class="row"> 
                        <div class="col-md-12">
                            <div class="komicho-input-group">
                                ...
                                <textarea rows="9" ng-model="projectAdd.about"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="komicho-input-group">
                                ...
                                <tags-input ng-model="tags">
                                  <auto-complete source="loadItems($query)" template="/tag/tag.html"></auto-complete>
                                </tags-input>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="komicho-input-group">
                                <button id="loadinged" ng-click="add()">حفظ المشروع</button>
